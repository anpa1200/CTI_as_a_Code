...
Once intake is complete → begin the [threat actor research](/docs/workflows/threat-actor-research) phase: map the actor's TTPs against the org's crown jewels and detection posture, then build the detection backlog.
...
- [CTI Analyst Field Manual](https://anpa1200.github.io/cti-analyst-field-manual/) — reference companion for proactive assessments
