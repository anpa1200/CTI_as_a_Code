...
- **[Quick Start](/docs/quick-start)** — lab up and running in 10 minutes
- **[Architecture](/docs/architecture)** — design decisions and data flows
- **[Methodology](/docs/cti-as-a-code-methodology)** — the full step-by-step CTI methodology
- **[Training](/docs/training)** — all 8 assignments with objectives and deliverables
- **[Case Studies](/docs/lifetech-pharma-case-study)** — published worked investigations
- **[Ecosystem](/docs/ecosystem)** — how this project fits with the Field Manual and other CTI projects
