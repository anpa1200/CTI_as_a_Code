...
The [Elastic SIEM](https://www.elastic.co/security) layer consists of [Elasticsearch](/CTI_as_a_Code/services/elasticsearch) (shared with the other services), [Kibana](https://www.elastic.co/security), and optionally Logstash for log ingestion.
...
Kibana's **Security** solution ([SIEM](/CTI_as_a_Code/services/elastic-siem)) provides:
...
- Threat intelligence indicator matching (see [threat feeds](/CTI_as_a_Code/integrations/threat-feeds))
